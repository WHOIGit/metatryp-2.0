...
from proteomics.models import (Specialized_Assembly,TaxonDigest)
...
argparser = argparse.ArgumentParser(description=(
    'Generate combined redundancy tables for taxons and specialized assembly digests.'))
...
def main():
    ...
    tables = redundancy.generate_redundancy_tables_combined(taxon_digests, sa_digests, logger=logger)
